...
The **Edit** group provides controls for configuring the active layer and recording the reason and process for any attribute changes. It contains the following controls:
...
A drop-down list for selecting the reason for the attribute updates about to be made. A reason must be selected before any updates can be saved.
...
A drop-down list for selecting the process associated with the attribute updates about to be made. A process must be selected before any updates can be saved.
