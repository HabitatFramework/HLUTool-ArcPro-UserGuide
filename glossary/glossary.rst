...
.. glossary::
	...
	Physical Split
		Creates one or more new TOID fragments in the database based upon a single TOID which has been split in the map. See :ref:`physical_split` for more details.

	Physical Merge
		Combines two or more fragments of a single TOID into a single, larger, feature in the map. See :ref:`physical_merge` for more details.
